...
public class DriveSubsystem extends SubsystemBase
{
  ...
  public DriveSubsystem()
  {
    ...
    try
    {
      swerveDrive = new SwerveParser(swerveJsons).createSwerveDrive(Constants.Drive.maxSpeed, startingPose);
  ...
  {
    SmartDashboard.putData("swerve pose",(Sendable) swerveDrive.getPose());
  }
