...
public class FieldConstants {
    ...
    public static AprilTagFieldLayout kAprilTagFieldLayout = AprilTagFieldLayout.loadField(AprilTagFields.k2026RebuiltWelded);

    // AprilTag related constants
    public static final int aprilTagCount = kAprilTagFieldLayout.getTags().size();
    public static final double aprilTagWidth = Units.inchesToMeters(6.5);

    // Field dimensions
    public static final double fieldLength = kAprilTagFieldLayout.getFieldLength();
    public static final double fieldWidth = kAprilTagFieldLayout.getFieldWidth();
    ...
    */
    public static class LinesVertical {
        ...
        public static final double starting =
            kAprilTagFieldLayout.getTagPose(26).get().getX();
        public static final double allianceZone = starting;
        public static final double hubCenter =
            kAprilTagFieldLayout.getTagPose(26).get().getX() + Hub.width / 2.0;
        ...
        public static final double redHubCenter =
            kAprilTagFieldLayout.getTagPose(4).get().getX() + Hub.width / 2.0;
        public static final double redAllianceZone =
            kAprilTagFieldLayout.getTagPose(10).get().getX();
    }
    ...
    public static class Hub {
        ...
        public static final Translation3d topCenterPoint =
            new Translation3d(
                kAprilTagFieldLayout.getTagPose(26).get().getX() + width / 2.0,
                fieldWidth / 2.0,
                height);
        ...
        // Relevant reference points on the red side
        public static final Translation3d redTopCenterPoint =
            new Translation3d(
                kAprilTagFieldLayout.getTagPose(4).get().getX() + width / 2.0,
                fieldWidth / 2.0,
                innerHeight);
        ...
        public static final Pose2d nearFace =
            kAprilTagFieldLayout.getTagPose(26).get().toPose2d();
        public static final Pose2d farFace =
            kAprilTagFieldLayout.getTagPose(20).get().toPose2d();
        public static final Pose2d rightFace =
            kAprilTagFieldLayout.getTagPose(18).get().toPose2d();
        public static final Pose2d leftFace =
            kAprilTagFieldLayout.getTagPose(21).get().toPose2d();
    }
    ...
    public static class LeftBump {
        ...
        // Relevant reference points on red side
        public static final Translation2d redNearLeftCorner =
            new Translation2d(LinesVertical.hubCenter - width / 2, Units.inchesToMeters(255));
        public static final Translation2d redNearRightCorner = Hub.redNearLeftCorner;
        public static final Translation2d redFarLeftCorner =
            new Translation2d(LinesVertical.hubCenter + width / 2, Units.inchesToMeters(255));
        public static final Translation2d redFarRightCorner = Hub.redFarLeftCorner;
    }
    ...
    public static class LeftTrench {
        ...
        // Relevant reference points on red side
        public static final Translation3d redOpeningTopLeft =
            new Translation3d(LinesVertical.redHubCenter, fieldWidth, openingHeight);
        public static final Translation3d redOpeningTopRight =
            new Translation3d(LinesVertical.redHubCenter, fieldWidth - openingWidth, openingHeight);
    }
    ...
    public static class RightTrench {
        ...
        // Relevant reference points on red side
        public static final Translation3d redOpeningTopLeft =
            new Translation3d(LinesVertical.redHubCenter, openingWidth, openingHeight);
        public static final Translation3d redOpeningTopRight =
            new Translation3d(LinesVertical.redHubCenter, 0, openingHeight);
    }
    ...
    public static class Tower {
        ...
        public static final Translation2d centerPoint =
            new Translation2d(
                frontFaceX, kAprilTagFieldLayout.getTagPose(31).get().getY());
        public static final Translation2d leftUpright =
            new Translation2d(
                frontFaceX,
                (kAprilTagFieldLayout.getTagPose(31).get().getY())
                    + innerOpeningWidth / 2
        ...
        // Relevant reference points on red side
        public static final Translation2d redCenterPoint =
            new Translation2d(
                fieldLength - frontFaceX,
                kAprilTagFieldLayout.getTagPose(15).get().getY());
        public static final Translation2d redLeftUpright =
            new Translation2d(
                fieldLength - frontFaceX,
                (kAprilTagFieldLayout.getTagPose(15).get().getY())
                    + innerOpeningWidth / 2
                    + Units.inchesToMeters(0.75));
        public static final Translation2d redRightUpright =
            new Translation2d(
                fieldLength - frontFaceX,
                (kAprilTagFieldLayout.getTagPose(15).get().getY())
                    - innerOpeningWidth / 2
    ...
    public static class Outpost {
        ...
        // Relevant reference points on alliance side
        public static final Translation2d centerPoint =
            new Translation2d(0, kAprilTagFieldLayout.getTagPose(29).get().getY());
    }
